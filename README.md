...
大家好！我叫赵慧楠，郑州轻工业大学软件工程专业在校生。

这是我第一次在 AI 的帮助下独立全栈开发并部署在阿里云的项目，前后历时大约十天。

做完这个项目，我最深的感受就是 AI 的强大。还记得大一写实验报告时借助的是文心一言等工具，后来 ChatGPT 问世，再到现在的 Claude Opus 和 Codex 模型，科技发展速度惊人，让我深深感叹科技的力量。

希望通过这个项目记录我的成长，也希望自己能一直保持一颗好学的心和强大的心态，在软件工程的道路上继续前进！

---

## 项目简介

SyncBoard 是一个基于 Spring Boot 和 WebSocket 的实时协作看板应用，类似于 Trello。它支持多人实时协作、任务拖拽排序、在线状���同步等功能，适用于团队项目管理、敏捷开发等场景。
